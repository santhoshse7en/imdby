...
from imdb.utils.helpers import catch, catch_dict, catch_list, unicode
...
class plot_keywords:
    ...
    def __init__(self, title_id):
        ...
        self.plot_keywords = catch_list(
            lambda: [tag['data-item-keyword'] for tag in block])

        """
        :returns: Creates Dict from the above info. if available.
        """
        self.imdb_plot_Keywords_metadata = catch_dict(lambda: {"Movie Name": self.title,
